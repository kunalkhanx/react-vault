...
const PasswordItem = ({ password, onEditMode }) => {
    ...
    return (
        <div className='rounded-md border bg-white py-2 px-4 flex flex-col gap-1 text-sm relative [&>.action-btns]:hidden [&>.action-btns]:hover:flex'>
            <div className='items-center gap-1 absolute right-2 top-1 action-btns'>
                ...
                <button type='button' className='p-1 hover:text-red-500 transition-all'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
