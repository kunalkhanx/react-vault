...
const SelectInput = ({className, label, placeholder, error, value, setValue, data = []}) => {
  ...
  return (
    <div className={`${className} w-full`}>
        ...
        <select onChange={onChangeHandler} value={value} className='py-1.5 px-3 rounded bg-zinc-100 focus:bg-white border focus:outline-none focus:border-rose-500 block w-full' id={inputId}>
